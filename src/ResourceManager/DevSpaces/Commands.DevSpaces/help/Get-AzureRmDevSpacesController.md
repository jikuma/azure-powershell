...
```
Get-AzureRmDevSpacesController -ResourceId <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### InputObjectParameterSet
```
Get-AzureRmDevSpacesController -InputObject <PSController> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```
